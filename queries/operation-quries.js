const InventoryQueris = {
    insertInventory : 'INSERT INTO inventory(item_name, price_per_item, taxes, quantity_type, quantity_remaining,status) VALUES (?,?,?,?,?, 1)',
    ...
    getInventories : 'SELECT item_id, item_name, price_per_item, taxes, quantity_type, quantity_remaining FROM inventory WHERE status != 99'
};
